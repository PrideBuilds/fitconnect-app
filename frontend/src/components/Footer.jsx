    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold mb-4">About FitConnect</h3>
            <p className="text-gray-300 text-sm">
              Connecting travelers with personal trainers and gyms across the United States.
              Your fitness journey, anywhere.
            </p>
          </div>
